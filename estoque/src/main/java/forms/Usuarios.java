    ...
    private void preencherTabela() {
        try {
            ...
            while (resultSet.next()) {
                ...
                String coluna3 = resultSet.getString("usuario");
                String coluna4 = resultSet.getString("senha");
...
private void search() {
    ...
    try {
        ...
        while (resultSet.next()) {
            Object[] row = { resultSet.getInt("id"), resultSet.getString("nome"),
                    resultSet.getString("usuario"), resultSet.getString("senha") };
            model.addRow(row);
        }
    ...
    usuario.atualizarTabelaUsuario(modeloTabela);
    preencherTabela();
    searchBar.setText("");
        ...
        if (linhaSelecionada != -1) {
            ...
            if (idRegistroObject != null) {
                if (idRegistroObject instanceof Integer || idRegistroObject instanceof String) {
                    ...
                    boolean exclusaoBemSucedida = usuario.excluirRegistroNoBanco(idRegistro);
