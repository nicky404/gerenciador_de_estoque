...
public class Estoque extends javax.swing.JFrame {
    ...
    private void preencherTabela() {
        try {
            ...
            while (resultSet.next()) {
                ...
                String coluna3 = resultSet.getString("preço");
                String coluna4 = resultSet.getString("qntEstoque");
                // Adicione mais colunas conforme necessário

                model.addRow(new Object[]{coluna1, coluna2, coluna3, coluna4});
            }
        ...
        try {
            ...
            while (resultSet.next()) {
                Object[] row = { resultSet.getInt("id"), resultSet.getString("nome"),
                        resultSet.getDouble("preço"), resultSet.getInt("qntEstoque") };
                model.addRow(row);
            }
    ...
    produto.atualizarTabelaProduto(modeloTabela);
    preencherTabela();
    searchBar.setText("");
        ...
        if (linhaSelecionada != -1) {
            ...
            if (idRegistroObject != null) {
                if (idRegistroObject instanceof Integer || idRegistroObject instanceof String) {
                    ...
                    boolean exclusaoBemSucedida = produto.excluirRegistroNoBanco(idRegistro);
